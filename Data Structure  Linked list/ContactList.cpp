...
{
	cout<< "thank you for using contacts! ";
}
...
void ContactList::revprinting()
{
	revprintlist(head);
}

void ContactList::revprintlist(Contact *curr)
{
	if(curr != 0)
	{
		revprintlist(curr->next);
		cout << *curr << endl;

	}
}

//void ContactList::printlist()     //iterative
//{
//	Contact *tp = head;
//
//	while(tp != 0)
